...
const v4 = function(Spawner) // level 4
{
	...
	if(numberOfHarvesters < minimalNumberOfHarverters)
	{
		...
		if(numberOfHarvesters > 3)
		{
		    Spawner.spawnCustomCreep("Harvester", "harvester", "WWWCCCMMMM", {source: sourceId});
		}
		else if(numberOfHarvesters > 2)
		{
		    Spawner.spawnCustomCreep("Harvester", "harvester", "WWCCMMM", {source: sourceId});
		}
		else
		{
		    Spawner.spawnCustomCreep("Harvester", "harvester", "WCMM", {source: sourceId});
	...
	{
		Spawner.spawnCustomCreep("Upgrader", "upgrader", "WWWCCCMMMM");
	}
	else if(numberOfEngineers < minimalNumberOfEngineers)
	{
		Spawner.spawnCustomCreep("Engineer", "engineer", "WWWCCCMMMM");
	}
	else if(numberOfBuilders < minimalNumberOfBuilders)
	{
		Spawner.spawnCustomCreep("Builder", "builder", "WWWCCCMMMM");
	}
	else if(numberOfPorters < minimalNumberOfPorters)
	{
		Spawner.spawnCustomCreep("Porter", "porter", "CCCCCMMMMM");
	}
}
